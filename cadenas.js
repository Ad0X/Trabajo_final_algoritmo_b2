class Cadena{
 ...
 // respuesta="hola tal" -->
  ...
  igual() {
    ...
    // Recorremos la frase al revés y construimos char2
  ...
  separador(){
      //<!-- Dada una frase y un caracter separador. Se pide pasar esa frase a un arreglo tal como seindica en el ejemplo 
     //Ejemplo: frase = "20;40;50;60"  caracterSeparador=";" Respuesta=["20","40","50","60"]  -->
    let frase1 = document.getElementById("datos").value;
